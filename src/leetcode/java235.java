...
public class java235 {
    ...
    class Solution {
        ...
        public TreeNode lowestCommonAncestor(TreeNode root, TreeNode p, TreeNode q) {
            ...
            TreeNode temp =root;
            while (!(p.val<temp.val&&q.val>temp.val)){
                if (p.val<temp.val)temp=temp.left;
                else if (p.val>temp.val)temp=temp.right;
                else break;
            }
            return temp;
        }
...
//            TreeNode temp1 = dfs(root,p);
//            TreeNode temp2 = dfs(root,q);
//            while (temp1!=temp2){
//                temp1=dfs(root,temp1);
//                temp2=dfs(root,temp2);
//            }
